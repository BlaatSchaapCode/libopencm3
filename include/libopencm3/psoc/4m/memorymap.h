...
//PA
//PASS MMIO
#define PERI_BASE 				(PERIPH_BASE + 0x010000)
//ROUTE == 
...
#define HSIOM_PORT0_BASE		(PERIPH_BASE + 0x20000)
#define HSIOM_PORT1_BASE		(PERIPH_BASE + 0x20100)
#define HSIOM_PORT2_BASE		(PERIPH_BASE + 0x20200)
#define HSIOM_PORT3_BASE		(PERIPH_BASE + 0x20300)
#define HSIOM_PORT4_BASE		(PERIPH_BASE + 0x20400)
#define HSIOM_PORT5_BASE		(PERIPH_BASE + 0x20500)
#define HSIOM_PORT6_BASE		(PERIPH_BASE + 0x20600)
#define HSIOM_PORT7_BASE		(PERIPH_BASE + 0x20700)
